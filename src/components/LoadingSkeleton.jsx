...
export default function LoadingSkeleton() {
  return (
    <div className="bg-slate-800 rounded-xl shadow-md overflow-hidden border border-slate-700 min-h-[350px] sm:min-h-[400px]">
      <div className="p-6 sm:p-8 animate-pulse">
        ...
        <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-6">
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className="py-3 sm:py-4 px-2 sm:px-3 bg-slate-700/50 rounded-lg border border-slate-600"
            >
...
export const ProfileSkeleton = () => (
  <div className="text-center space-y-3">
    <div className="w-10 h-10 bg-slate-700 rounded-full animate-pulse mx-auto"></div>
    <div className="space-y-2">
      <div className="h-4 bg-slate-700 rounded animate-pulse"></div>
      <div className="h-3 bg-slate-700 rounded w-3/4 mx-auto animate-pulse"></div>
    </div>
  </div>
);
