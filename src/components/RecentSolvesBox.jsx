...
export default function RecentSolvesBox({
  statsMap,
  usernames,
  loadingUsers,
  compactMode = false,
              ...
              latestProblems.map((problem, index) => {
                ...
                return (
                  <div
                    ...
                    className={`p-2 rounded-lg border ${colors.bg} ${colors.border} hover:bg-gray-600/50 transition-colors`}
                  >
                    <div className="flex items-start justify-between gap-2 mb-1">
                      ...
                      <span
                        className={`px-1.5 py-0.5 rounded text-xs font-medium ${colors.badge} shrink-0`}
                      >
                        {problem.difficulty}
                      </span>
                    </div>
